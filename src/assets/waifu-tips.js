...
$('.waifu-tool .fui-info-circle').click(function (){
    window.open('https://www.cnblogs.com/zhaizx/');
});
...
function waifuWelcome(){
    var text;
    var SiteIndexUrl = 'https://www.cnblogs.com/zhaizx/';  // 手动指定主页
...
function loadModel(modelId, modelTexturesId){
    ...
    loadlive2d('live2d', 'https://www.electronicute.cn/Models/Arisa/arisa.model.json', console.log('live2d', '模型加载完成'));
/*-*/
}
